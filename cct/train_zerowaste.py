...
def main(config, resume):
    ...
    supervised_loader = dataloaders.ZeroWaste(config['train_supervised'])
    unsupervised_loader = dataloaders.ZeroWaste(config['train_unsupervised'])
    val_loader = dataloaders.ZeroWaste(config['val_loader'])
