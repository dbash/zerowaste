...
sys.path.insert(1,'/research/axns2/mabdelfa/core/puzzle_zerowaste')
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        for step, (ori_image, image_id, label, gt_mask) in enumerate(dataset):
            ...
            rw = propagate_to_edge(cam_downsized_values, edge, beta=args.beta, exp_times=args.exp_times, radius=10)
