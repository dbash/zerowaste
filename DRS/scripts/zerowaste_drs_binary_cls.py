...
from utils.LoadData import train_data_loader, valid_data_loader, ZeroWaste_data_loaders
...
def validate(current_epoch):
    ...
    with torch.no_grad():
        for idx, dat in tqdm(enumerate(val_loader)):
            ...
            print('gt_map shape is: ', gt_map.shape) """

            """ print()
            print('cam type is: ', type(cam))
            print('pred_map type is: ', type(pred_map))
            print('gt_map type is: ', type(gt_map)) """
...
def train(current_epoch):
    ...
    for idx, dat in enumerate(train_loader):
        ...
        print('loss is: ', loss)
        print() """
        #loss = F.BCEWithLogitsLoss(logit, label)
...
if __name__ == '__main__':
    ...
    #print('# of test dataset:', len(test_loader) * args.batch_size)
    print()
