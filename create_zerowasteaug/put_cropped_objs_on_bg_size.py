...
dir = "/research/axns2/mabdelfa/TACO/data/plastic_1_cropped_objs"
save_dir = "/research/axns2/mabdelfa/TACO/data/plastic_2_bg_size/"

category_name = "plastic"
category_id = 1

objs_json_file = dir + '/remember_objs.json'
