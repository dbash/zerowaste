...
for index in range(total_epoch):
    ...
    conf_mat_to_png(l_conf_mat, save_me + '_train_cm.png', save_me + '_train_cm.csv')
    ...
    with torch.no_grad():
        ...
        log_func('metal: {}'.format(class_losses[3]))
        log_func('soft_plastic: {}'.format(class_losses[4]))
        conf_mat_to_png(conf_mat, save_me + '_val_cm.png', save_me + '_val_cm.csv')
