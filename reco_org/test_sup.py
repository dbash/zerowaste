...
# org_sup_test_org.txt
# org_sup_test_aug.txt
# org_sup_test_comb.txt

save_me = 'org_sup_test_comb'
...
model.load_state_dict(torch.load('model_weights/pascal_label0_sup_reco_0.pth', map_location=device))
