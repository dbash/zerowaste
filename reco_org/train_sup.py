...
for index in range(total_epoch):
    ...
    conf_mat_to_png(conf_mat, 'sup_org_train_conf_matrix.png', 'sup_org_train_conf_matrix.csv')
    ...
    with torch.no_grad():
        ...
        log_func('metal: {}'.format(class_losses[3]))
        log_func('soft_plastic: {}'.format(class_losses[4]))
        conf_mat_to_png(conf_mat, 'sup_org_val_conf_matrix.png', 'sup_org_val_conf_matrix.csv')
