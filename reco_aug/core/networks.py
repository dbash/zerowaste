...
class Backbone(nn.Module, ABC_Model):
    def __init__(self, model_name, num_classes=4, mode='fix', segmentation=False):
        super().__init__()
...
class Classifier(Backbone):
    def __init__(self, model_name, num_classes=4, mode='fix'):
...
class DeepLabv3_Plus(Backbone):
    def __init__(self, model_name, num_classes=5, mode='fix', use_group_norm=False):
