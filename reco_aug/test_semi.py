...
parser.add_argument('--checkpoint', default='model_weights/pascal_label60_semi_classmix_reco_0.pth', type=str)
...
# aug_semi_test_org.txt
# aug_semi_test_aug.txt
# aug_semi_test_comb.txt

save_me = 'aug_semi_test_org_try'
